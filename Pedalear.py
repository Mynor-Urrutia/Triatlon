class Pedaleando:
    ...
    def __init__(self):
        print("Inicio de la Carrera de Ciclismo")
    ...
    def Visualizacion(self):
        print("El equipo 1 tiene una velocidad media en ciclismo es de: ", self.dmEquipo1)
        print("El equipo 2 tiene una velocidad media en ciclismo es de: ", self.dmEquipo2)
